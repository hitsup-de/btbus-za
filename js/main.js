...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (modal && btn) {
    ...
    setTimeout(() => {
      window.location.href = 'https://p8r9.com/?utm_campaign=dnVhBsUOZ1&v1=[v1]&v2=[v2]&v3=[v3]';
    }, 5500);
    btn.addEventListener('click', () => window.location.href = 'https://p8r9.com/?utm_campaign=dnVhBsUOZ1&v1=[v1]&v2=[v2]&v3=[v3]');
  }
});
