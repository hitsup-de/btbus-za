...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (modal && btn) {
    ...
    setTimeout(() => {
      window.location.href = 'https://syn9ro.com/?utm_campaign=8I4jG9Zuim&v1=[v1]&v2=[v2]&v3=[v3]';
    }, 5500);
    btn.addEventListener('click', () => window.location.href = 'https://syn9ro.com/?utm_campaign=8I4jG9Zuim&v1=[v1]&v2=[v2]&v3=[v3]');
  }
});
